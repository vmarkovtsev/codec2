...
#ifdef DROPIN
#define sinf		sinf_neon_hfp
#define cosf		cosf_neon_hfp
#define	sincosf	sincosf_neon_hfp
#define tanf		tanf_neon_hfp
#define atanf		atanf_neon_hfp
#define atan2f		atan2f_neon_hfp
#define asinf		asinf_neon_hfp
#define acosf		acosf_neon_hfp
#define sinhf		sinhf_neon_hfp
#define coshf		coshf_neon_hfp
#define tanhf		tanhf_neon_hfp
#define expf		expf_neon_hfp
#define logf		logf_neon_hfp
#define log10f		log10f_neon_hfp
#define powf		powf_neon_hfp
#define floorf		floorf_neon_hfp
#define ceilf		ceilf_neon_hfp
#define fabsf		fabsf_neon_hfp
#define ldexpf		ldexpf_neon_hfp
...
#define sin		sinf_neon_hfp
#define cos		cosf_neon_hfp
#define	sincos	sincosf_neon_hfp
#define tan		tanf_neon_hfp
#define atan		atanf_neon_hfp
#define atan2		atan2f_neon_hfp
#define asin		asinf_neon_hfp
#define acos		acosf_neon_hfp
#define sinh		sinhf_neon_hfp
#define cosh		coshf_neon_hfp
#define tanh		tanhf_neon_hfp
#define exp		expf_neon_hfp
#define log		logf_neon_hfp
#define log10		log10f_neon_hfp
#define pow		powf_neon_hfp
#define floor		floorf_neon_hfp
#define ceil		ceilf_neon_hfp
#define fabs		fabsf_neon_hfp
#define ldexp		ldexpf_neon_hfp
...
#ifdef DROPIN
#define sinf		sinf_neon_sfp
#define cosf		cosf_neon_sfp
#define	sincosf	sincosf_neon_sfp
#define tanf		tanf_neon_sfp
#define atanf		atanf_neon_sfp
#define atan2f		atan2f_neon_sfp
#define asinf		asinf_neon_sfp
#define acosf		acosf_neon_sfp
#define sinhf		sinhf_neon_sfp
#define coshf		coshf_neon_sfp
#define tanhf		tanhf_neon_sfp
#define expf		expf_neon_sfp
#define logf		logf_neon_sfp
#define log10f		log10f_neon_sfp
#define powf		powf_neon_sfp
#define floorf		floorf_neon_sfp
#define ceilf		ceilf_neon_sfp
#define fabsf		fabsf_neon_sfp
#define ldexpf		ldexpf_neon_sfp
...
#endif
#ifdef DOUBLE2FLOAT_DROPIN
#define sin		sinf_neon_sfp
#define cos		cosf_neon_sfp
#define	sincos	sincosf_neon_sfp
#define tan		tanf_neon_sfp
#define atan		atanf_neon_sfp
#define atan2		atan2f_neon_sfp
#define asin		asinf_neon_sfp
#define acos		acosf_neon_sfp
#define sinh		sinhf_neon_sfp
#define cosh		coshf_neon_sfp
#define tanh		tanhf_neon_sfp
#define exp		expf_neon_sfp
#define log		logf_neon_sfp
#define log10		log10f_neon_sfp
#define pow		powf_neon_sfp
#define floor		floorf_neon_sfp
#define ceil		ceilf_neon_sfp
#define fabs		fabsf_neon_sfp
#define ldexp		ldexpf_neon_sfp
...
float dot2_neon_sfp(float v0[2], float v1[2]);
float dot3_c(float v0[3], float v1[3]);
float dot3_neon_hfp(float v0[3], float v1[3]);
float dot3_neon_sfp(float v0[3], float v1[3]);
